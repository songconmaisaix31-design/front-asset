...
| Stable paths and hashes | Reviewed source paths and hashes match current manifests for MOT and final COS. DEPT's actual LF HTML is `1c6b6923…`, while the R2-REF fragment/HANDOFF reports `1c6d6923…`; without before/after bytes this fragment discrepancy cannot establish overwrite. | Direct current check |
...
The preserved DEPT HTML currently hashes to `1c6b6923b1ff2bdc1bada5ce80243d96bf2c65d48fd0dc9f99cb2b68571138bc`, while the R2-REF fragment/HANDOFF reports `1c6d6923b1ff2bdc1bada5ce80243d96bf2c65d48fd0dc9f99cb2b68571138bc`. Root final catalog should retain the actual SHA and `fragment_reported_sha256`; without before/after bytes, the discrepancy cannot prove overwrite. It contains four Vimeo IDs (`718320881`, `718668646`, `718668346`, `718668582`), with no verified media. CONTROL-R2's 1792×869 decoded DEPT image is a huge bright core: rejected style, not coverage.
